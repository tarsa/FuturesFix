...
package futures.after

import futures.after.concurrent.duration.Duration
...
package object concurrent {
  ...
  def blocking[T](body: =>T): T = BlockContext.current.blockOn(body)(futures.after.concurrent.AwaitPermission)
}
