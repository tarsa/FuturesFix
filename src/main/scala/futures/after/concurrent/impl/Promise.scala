...
package futures.after.concurrent.impl

import futures.after.concurrent.{ ExecutionContext, CanAwait, OnCompleteRunnable, TimeoutException, ExecutionException, blocking }
import futures.after.concurrent.Future.InternalCallbackExecutor
import futures.after.concurrent.duration.{ Duration, Deadline, FiniteDuration, NANOSECONDS }
...
private[concurrent] trait Promise[T] extends futures.after.concurrent.Promise[T] with futures.after.concurrent.Future[T] {
