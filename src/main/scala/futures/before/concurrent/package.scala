...
package futures.before

import futures.before.concurrent.duration.Duration
...
package object concurrent {
  ...
  def blocking[T](body: =>T): T = BlockContext.current.blockOn(body)(futures.before.concurrent.AwaitPermission)
}
