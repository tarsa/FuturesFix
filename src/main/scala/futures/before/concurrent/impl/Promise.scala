...
package futures.before.concurrent.impl

import futures.before.concurrent.{ ExecutionContext, CanAwait, OnCompleteRunnable, TimeoutException, ExecutionException, blocking }
import futures.before.concurrent.Future.InternalCallbackExecutor
import futures.before.concurrent.duration.{ Duration, Deadline, FiniteDuration, NANOSECONDS }
...
private[concurrent] trait Promise[T] extends futures.before.concurrent.Promise[T] with futures.before.concurrent.Future[T] {
