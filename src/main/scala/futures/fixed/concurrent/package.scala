...
package futures.fixed

import futures.fixed.concurrent.duration.Duration
...
package object concurrent {
  ...
  def blocking[T](body: =>T): T = BlockContext.current.blockOn(body)(futures.fixed.concurrent.AwaitPermission)
}
