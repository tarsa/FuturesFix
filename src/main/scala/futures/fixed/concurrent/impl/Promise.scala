...
package futures.fixed.concurrent.impl

import futures.fixed.concurrent.{ ExecutionContext, CanAwait, OnCompleteRunnable, TimeoutException, ExecutionException, blocking }
import futures.fixed.concurrent.Future.InternalCallbackExecutor
import futures.fixed.concurrent.duration.{ Duration, Deadline, FiniteDuration, NANOSECONDS }
...
private[concurrent] trait Promise[T] extends futures.fixed.concurrent.Promise[T] with futures.fixed.concurrent.Future[T] {
